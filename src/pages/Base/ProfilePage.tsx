...
const carListings = [
    {
        ...
        status: "ENDED",
        endDate: "Aug 15, 2025",
        description: "Extremely Modified Garage Queen. Dyno Verified. Capable 4 Speed Sequential Race",
    },
    {
        id: 2,
        image: "https://images.unsplash.com/photo-1614200187524-dc4b892acf16?w=800&q=80",
        ...
        status: "ENDED",
        endDate: "Aug 18, 2025",
        description: "White Interior, Unmodified, and well maintained. No accidents",
    },
    {
        id: 3,
        image: "https://images.unsplash.com/photo-1614200187524-dc4b892acf16?w=800&q=80",
    ...
    },
    {
        ...
        status: "ENDED",
        endDate: "Aug 16, 2025",
        description: "US Spec AWD Escalade Service Completed. Unmodified. California Owned",
    },
    {
        id: 6,
        image: "https://images.unsplash.com/photo-1614200187524-dc4b892acf16?w=800&q=80",
        ...
        status: "ENDED",
        endDate: "Aug 18, 2025",
        description: "6 Speed Manual. Stock Suspension. Factory Owner. Mostly Unmodified",
    },
    {
        id: 7,
        image: "https://images.unsplash.com/photo-1614200187524-dc4b892acf16?w=800&q=80",
    ...
    },
    {
        ...
        status: "ENDED",
        endDate: "Aug 15, 2025",
        description: "6600 Miles. 6 Speed Manual. 350 hp. Pristine Final & Unmodified",
    },
];
...
const comments = [
    {
        ...
        comment: "Do you have a picture of what not exactly have access to some sections. Wasn't able to view some areas.",
    },
    {
        id: 2,
        image: "https://images.unsplash.com/photo-1614200187524-dc4b892acf16?w=800&q=80",
                    ...
                    <div className="flex-1 max-w-[1072px]">
                            ...
                            <div className="flex flex-col gap-6">
                                <div className="flex flex-col min-[900px]:flex-row items-center min-[900px]:justify-center min-[1280px]:items-stretch gap-6 w-full">
                                    ...
                                    >
                                        ...
                                        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity z-20">
                                            <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M43.5 12H28.5L21 21H12C10.4087 21 8.88258 21.6321 7.75736 22.7574C6.63214 23.8826 6 25.4087 6 27V54C6 55.5913 6.63214 57.1174 7.75736 58.2426C8.88258 59.3679 10.4087 60 12 60H60C61.5913 60 63.1174 59.3679 64.2426 58.2426C65.3679 57.1174 66 55.5913 66 54V27C66 25.4087 65.3679 23.8826 64.2426 22.7574C63.1174 21.6321 61.5913 21 60 21H51L43.5 12Z" stroke="white" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M36 48C40.9706 48 45 43.9706 45 39C45 34.0294 40.9706 30 36 30C31.0294 30 27 34.0294 27 39C27 43.9706 31.0294 48 36 48Z" stroke="white" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex-1 flex flex-col gap-4 w-full items-center min-[900px]:items-start">
                                        <h1 className="text-2xl font-bold text-white text-center min-[900px]:text-left">Danyil Korotkov</h1>
                                        <div className="flex flex-wrap gap-2 mt-1 justify-center min-[900px]:justify-start">
                                            <div className="flex items-center gap-2 shrink-0">
                                                ...
                                                <p className="text-[15px] text-white">Registered Bidder</p>
                                            </div>
                                        ...
                                        <div className="flex items-center gap-6 mt-4 max-h-[24px] justify-center min-[900px]:justify-start">
                                            <div className="flex items-center gap-2">
                                                <div className="text-[17px] font-bold text-white">0</div>
                                        ...
                                        <div className="flex flex-col justify-end">
                                            ...
                                            >
                                                <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M9 2.5H3.16667C2.72464 2.5 2.30072 2.67559 1.98816 2.98816C1.67559 3.30072 1.5 3.72464 1.5 4.16667V15.8333C1.5 16.2754 1.67559 16.6993 1.98816 17.0118C2.30072 17.3244 2.72464 17.5 3.16667 17.5H14.8333C15.2754 17.5 15.6993 17.3244 16.0118 17.0118C16.3244 16.6993 16.5 15.8333V10" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                                    <path d="M14.3125 2.18751C14.644 1.85599 15.0937 1.66974 15.5625 1.66974C16.0313 1.66974 16.481 1.85599 16.8125 2.18751C17.144 2.51903 17.3303 2.96866 17.3303 3.43751C17.3303 3.90635 17.144 4.35599 16.8125 4.68751L9.30166 12.1992C9.10379 12.3969 8.85933 12.5416 8.59083 12.62L6.19666 13.32C6.12496 13.3409 6.04895 13.3422 5.97659 13.3236C5.90423 13.3051 5.83819 13.2675 5.78537 13.2146C5.73255 13.1618 5.6949 13.0958 5.67637 13.0234C5.65783 12.9511 5.65908 12.875 5.68 12.8033L6.38 10.4092C6.45877 10.1409 6.60378 9.89672 6.80166 9.69917L14.3125 2.18751Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                                </svg>
                                                Edit bio
                                            </button>
                        ...
                        <div className="mb-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
                                {carListings.map((car) => (
                                    <div key={car.id} className="bg-steria-dark-card rounded-xl overflow-hidden hover:bg-opacity-80 transition-all duration-200 border-1 border-custom-[#d0d0d0]">
                                        ...
                                        <div className="p-4">
                                            ...
                                            <p className="text-gray-500 text-xs mt-3">{car.endDate}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                                ...
                                {comments.map((comment) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 flex flex-col justify-between mt-3 lg:mt-0">
                                            <h3 className="text-white text-lg font-bold leading-tight">{comment.title}</h3>
                                            <p className="text-gray-400 text-sm mt-1">{comment.date}</p>
                                            <p className="text-gray-300 text-sm mt-3">{comment.comment}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
