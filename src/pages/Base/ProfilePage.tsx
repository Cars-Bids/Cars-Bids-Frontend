      ...
      <div className="max-w-[1440px] mx-auto py-8">
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex-shrink-0 p-2 w-full lg:w-auto">
            <div className="bg-white shadow-lg border border-gray-200 dark:border-none dark:shadow-none dark:bg-[#212121] rounded-xl p-3 lg:max-w-[200px]">
              <nav
                className="
              ...
              >
                <a
                  href="#"
                  className="block text-center lg:text-start py-1 text-black dark:text-white bg-steria-dark-card rounded-lg"
                >
                  Profile
                </a>
                <a
                  href="#"
                  className="block text-center lg:text-start py-1 text-black dark:text-white hover:bg-steria-dark-card rounded-lg transition-colors"
                >
                  Seller dashboard
                </a>
                <a
