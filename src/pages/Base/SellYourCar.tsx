...
const SellYourCar = () => {
        ...
        <div className="flex flex-col justify-start items-start gap-9 max-w-xl text-center lg:text-left">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-3">
              {["views", "bids", "money"].map((word, idx) => (
                <div key={idx}>
                  ...
                  <span className="text-black dark:text-white text-2xl md:text-[26px] font-bold font-amulya">
                    {" "}
                    {word}.
                  </span>
                </div>
          ...
          <div className="flex flex-col gap-5">
            <div className="flex items-start gap-3">
              ...
              <p className="text-black dark:text-white text-base font-medium font-synonym">
                <span className="text-lg font-bold">List for free</span> — you
                keep 100% of the sale price
              </p>
            </div>
            <div className="flex items-start gap-3">
              <Clock className="text-black dark:text-white" size={30} />
              <p className="text-black dark:text-white text-base font-medium font-synonym">
  ...
  Why choose Steria?
        ...
        <div className=" w-[80vw]  flex flex-wrap justify-center  sm:gap-8 lg:gap-9  lg:px-4 p-6 sm:p-8 rounded-xl bg-black/5 dark:bg-neutral-900  gap-y-6   items-center max-w-[1440px] mx-auto">
          ...
          <div className="flex flex-col items-center gap-4 w-full sm:w-64 md:w-72 p-4 rounded-xl border-2 border-red-500 bg-white dark:bg-neutral-900">
            ...
            <div className="text-center text-black dark:text-white text-lg sm:text-xl font-bold font-amula leading-tight">
  ...
  <div className="w-[80vw] py-6 sm:py-8 md:py-10 px-4 sm:px-6 md:px-10 rounded-[20px] inline-flex flex-col justify-center items-center gap-6 sm:gap-8 md:gap-9 overflow-hidden bg-black/5 dark:bg-[#121212]  max-w-[1440px] z-1">
    <div className="justify-start text-black dark:text-white text-xl sm:text-2xl md:text-3xl font-bold font-amulya">
  ...
  <div className="w-full sm:w-auto h-28 relative inline-flex flex-col justify-center items-start gap-2.5">
    <div className="left-[5px] sm:left-[-5.50px] top-[-20px] sm:top-[-32px] absolute justify-start text-red-600/20 text-6xl sm:text-8xl md:text-9xl font-bold font-synonym z-2">
      01
    </div>
    <div className="self-stretch flex flex-col justify-start items-start gap-2.5">
      <div className="justify-start text-black dark:text-white text-lg sm:text-xl md:text-2xl font-bold font-amulya z-3">
        Submit your car
      </div>
      <div className="self-stretch justify-start text-black dark:text-white text-sm sm:text-base md:text-lg font-medium font-synonym z-3">
