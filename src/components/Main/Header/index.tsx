...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-white to-white dark:from-neutral-900 dark:to-neutral-800 text-white dark:text-gray-200 px-4 py-3 shadow-md">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        ...
        <div className="hidden md:flex items-center gap-6 flex-1 justify-center">
          <a
            href="#"
            className={`hover:text-red-400 font-medium text-scaling dark:text-white text-black ${activeItem === "Auctions" ? "border-b-2 border-red-400 dark:border-red-400" : ""}`}
            onClick={() => dispatch(setActiveItem("Auctions"))}
          >
            Auctions
          </a>
          <Link
            to="/sell-your-car"
            className={`hover:text-red-400 font-medium text-scaling dark:text-white text-black ${activeItem === "Sell your car" ? "border-b-2 border-red-400 dark:border-red-400" : ""}`}
            onClick={() => dispatch(setActiveItem("Sell your car"))}
          >
            Sell your car
          </Link>
          <a
            href="#"
            className={`hover:text-red-400 font-medium text-scaling dark:text-white text-black ${activeItem === "What’s Steria?" ? "border-b-2 border-red-400 dark:border-red-400" : ""}`}
            onClick={() => dispatch(setActiveItem("What’s Steria?"))}
          >
            What’s Steria?
          </a>
          <a
            href="#"
            className={`hover:text-red-400 font-medium text-scaling dark:text-white text-black ${activeItem === "Leaderboard" ? "border-b-2 border-red-400 dark:border-red-400" : ""}`}
            onClick={() => dispatch(setActiveItem("Leaderboard"))}
          >
            Leaderboard
          </a>
        </div>
          ...
          <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
            ...
            >
              <div className="flex flex-col gap-6 mt-6">
                ...
                <a
                  href="#"
                  className={`hover:text-red-400 font-medium py-2 border-b border-neutral-700  text-center sm:text-left text-black dark:text-white text-scaling ${activeItem === "Auctions" ? "border-b-2 border-red-400 dark:border-red-400" : ""}`}
                  onClick={() => dispatch(setActiveItem("Auctions"))}
                >
                  Auctions
                </a>
                <Link
                  to="/sell-your-car"
                  className={`hover:text-red-400 font-medium py-2 border-b border-neutral-700  text-center sm:text-left text-black dark:text-white text-scaling ${activeItem === "Sell your car" ? "border-b-2 border-red-400 " : ""}`}
                  onClick={() => dispatch(setActiveItem("Sell your car"))}
                >
                  Sell your car
                </Link>
                <a
                  href="#"
                  className={`hover:text-red-400 font-medium py-2 border-b border-neutral-700  text-center sm:text-left text-black dark:text-white text-scaling ${activeItem === "What’s Steria?" ? "border-b-2 border-red-400 dark:border-red-400" : ""}`}
                  onClick={() => dispatch(setActiveItem("What’s Steria?"))}
                >
                  What’s Steria?
                </a>
                <a
                  href="#"
                  className={`hover:text-red-400 font-medium py-2 border-b border-neutral-700  text-center sm:text-left text-black dark:text-white text-scaling ${activeItem === "Leaderboard" ? "border-b-2 border-red-400 dark:border-red-400" : ""}`}
                  onClick={() => dispatch(setActiveItem("Leaderboard"))}
                >
                  Leaderboard
                </a>
