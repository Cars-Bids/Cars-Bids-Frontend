    ...
    <nav className="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-neutral-900 to-neutral-800 text-white px-4 py-3 shadow-lg">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        ...
        <div className="hidden md:flex items-center gap-6 flex-1 justify-center">
          <a
            href="#"
            className={`hover:text-red-400 font-medium text-scaling ${activeItem === "Auctions" ? "border-b-2 border-red-400" : ""}`}
          ...
          <a
            ...
            onClick={() => setActiveItem("What’s Steria?")}
          >
            What’s Steria?
          </a>
          <a
            href="#"
            className={`hover:text-red-400 font-medium text-scaling ${activeItem === "Leaderboard" ? "border-b-2 border-red-400" : ""}`}
        ...
        <div className="hidden md:flex items-center gap-3">
          <div className="flex items-center gap-2 bg-neutral-800 px-3 py-2 rounded-lg shadow-sm">
            ...
            <Input
              className="bg-transparent border-none focus-visible:ring-0 focus-visible:ring-offset-0 text-white placeholder:text-gray-400 text-scaling"
          ...
          <Button
            className="bg-gradient-to-r from-red-600 to-red-700 
                       ...
                       text-white font-semibold px-4 text-scaling-lg 
          ...
          <Sheet>
            <SheetTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                className="p-3 hover:bg-neutral-700 rounded-lg transition-all duration-200"
            ...
            <SheetContent
              side="left"
              className="bg-neutral-900 text-white w-80 p-6 transition-transform duration-300"
            >
              <div className="flex flex-col gap-6 mt-6">
                ...
                <a
                  href="#"
                  className={`hover:text-red-400 font-medium py-2 border-b border-neutral-700 text-scaling ${activeItem === "Leaderboard" ? "border-b-2 border-red-400" : ""}`}
                  onClick={() => setActiveItem("Leaderboard")}
                >
                  Leaderboard
                </a>
                ...
                <Button
                  className="bg-gradient-to-r from-red-600 to-red-700 
                             ...
                             hover:text-red-500 hover:border hover:border-red-500 
                             text-white w-full py-3 font-semibold text-scaling-lg mt-4 
                             transition-all duration-200 border border-transparent"
                >
                  SignUp
                </Button>
