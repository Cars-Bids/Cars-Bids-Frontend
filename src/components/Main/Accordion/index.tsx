  ...
  return (
   <div className="w-[80vw] inline-flex flex-col justify-start items-start gap-4 sm:gap-6 max-w-[1440px]">
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1" className="border-b border-black dark:border-white">
            <AccordionTrigger className="text-black dark:text-white text-2xl font-bold font-amulya py-2 flex justify-between items-start hover:no-underline my-4">
              How much does it cost to sell a car?
            </AccordionTrigger>
            <AccordionContent className="text-black dark:text-white text-base font-medium font-synonym pt-2">
              Listing a car on Cars & Bids is completely free — and sellers receive 100% of the final sale price!
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2" className="border-b border-black dark:border-white">
            <AccordionTrigger className="text-black dark:text-white text-2xl font-bold font-amulya py-2 flex justify-between items-start hover:no-underline my-4">
          ...
          <AccordionItem value="item-3" className="border-b border-black dark:border-white">
            <AccordionTrigger className="text-black dark:text-white text-2xl font-bold font-amulya py-2 flex justify-between items-start hover:no-underline my-4">
          ...
          <AccordionItem value="item-4" className="border-b border-black dark:border-white">
            <AccordionTrigger className="text-black dark:text-white text-2xl font-bold font-amulya py-2 flex justify-between items-start hover:no-underline my-4">
          ...
          <AccordionItem value="item-5" className="border-b border-black dark:border-white">
            <AccordionTrigger className="text-black dark:text-white text-2xl font-bold font-amulya py-2 flex justify-between items-start hover:no-underline my-4">
